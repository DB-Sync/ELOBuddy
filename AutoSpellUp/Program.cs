...
namespace AutoSpellUp
{
    ...
    /// This is a port of an Auto Leveler from L# but I do not have the source. Whose ever it is thank you! Made by DBSync
    ...
    internal class Program
    {
        ...
        private static void Game_OnStart(EventArgs args)
        {
            ...
            Menu.AddLabel(Player.ChampionName + " loaded. Credits to DBSync");
